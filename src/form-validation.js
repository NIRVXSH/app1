        ...
        style={{width:'400px',background:'#CEE'}}>
            <form onSubmit={handleSubmit(onSubmitForm)}>
                <div className="form-group mb-3">
                    <label htmlFor="cat" className="">หมวดหมู่ *</label>
                ...
                <div className="form-group mb-3">
                    ...
                    {errors.name&&<div style={err}>กำหนดราคาสินค้าเป็นตัวเลขที่มากกว่า0</div>}
                </div>
                <div className="form-group mb-3">
                ...
                <div className="form-group mb-3">
                    <label htmlFor="file" className="form-label">ภาพสินค้า *(ไม่เกิน 3ไฟล์ ขนาดสูงสุดไม่เกิน 300KB/ไฟล์)</label>
