                    ...
                    style.map((st,i) => {
                        return(
                            <div className="form-check form-check-inline mb-2">
                                <input type="checkbox" id={'check'+i} name="fontSize" value={st} className="form-check-input" onChange={onChangeCheck}/>
                                <label htmlFor={'check'+i} className="form-checked-label">{st}</label>
                            </div>
                            )
                    })
                }
                    ...
                    sizes.map((sz,i) => {
                        return(
                            <div className="form-check form-check-inline mb-2">
                                ...
                                <label htmlFor={'radio'+i} className="form-checked-label">{sz}</label>
                            </div>
                            )
                    })
                }
